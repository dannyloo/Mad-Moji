...
public class CenteredLabel extends Label implements AhhhroundGameElement {
    ...
    public CenteredLabel(com.qeue.ahhh_round.components.Font font, Color color, double parentHeight, double centerAroundX, double centerAroundY) {
        this("", font, color, parentHeight, centerAroundX, centerAroundY);
    }

    public CenteredLabel(CharSequence text, com.qeue.ahhh_round.components.Font font, Color color, double parentHeight, double centerAroundX, double centerAroundY) {
