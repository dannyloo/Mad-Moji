...
public class RectangleButton extends Group implements AhhhroundGameElement {
    ...
    public RectangleButton(double width, double height, String text, final Style buttonStyle) {
        ...
        Pixmap buttonPixmap = com.qeue.ahhh_round.utils.PixmapUtil.getPixmapRoundedRectangle(width * higherQualityScalingConstant, height * higherQualityScalingConstant, buttonStyle.cornerRadius * 3);
