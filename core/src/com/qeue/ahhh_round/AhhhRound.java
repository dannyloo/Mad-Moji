...
import com.qeue.ahhh_round.components.Image;
import com.qeue.ahhh_round.components.JumpInputListener;
import com.qeue.ahhh_round.components.Player;
import com.qeue.ahhh_round.components.Point;
import com.qeue.ahhh_round.components.RectangleButton;
...
import com.qeue.ahhh_round.utils.ScoreUpdater;
...
public class AhhhRound extends ApplicationAdapter {
    ...
    private com.qeue.ahhh_round.utils.FontFactory fontFactory;
    ...
    private List<com.qeue.ahhh_round.components.Character> enemies = new ArrayList<com.qeue.ahhh_round.components.Character>();
    private com.qeue.ahhh_round.components.Character killer;
    private Player player;
    private List<com.qeue.ahhh_round.components.AhhhroundGameElement> menuElements = new ArrayList<com.qeue.ahhh_round.components.AhhhroundGameElement>();
    private List<com.qeue.ahhh_round.components.AhhhroundGameElement> inGameElements = new ArrayList<com.qeue.ahhh_round.components.AhhhroundGameElement>();
    private Image logo;
    private Image centerCircle;
    private Image splashScreenLogo;
    private com.qeue.ahhh_round.components.CenteredLabel gameOverLabel;
    private com.qeue.ahhh_round.components.CenteredLabel gameOverScoreLabel;
    ...
    private void setupConstants() {
        ...
        midX = width / 2;
        midY = height / 2;
        com.qeue.ahhh_round.utils.AssetSizeUtil.setup(width, height);
        playerRadius = com.qeue.ahhh_round.utils.AssetSizeUtil.getHeightIndifferentConstant();
    ...
    private void loadAssets() {
        ...
        fontFactory = new com.qeue.ahhh_round.utils.FontFactory(assetManager);
        ...
        for (com.qeue.ahhh_round.components.CharacterSkin skin : characterSkinStore.getAllSkins()) {
    ...
    private void setupLabels() {
        ...
        stage.addActor(logo);
        gameOverLabel = new com.qeue.ahhh_round.components.CenteredLabel(fontFactory.get(REGULAR_FONT), Color.OFF_BLACK, height, midX, height - 2 * lineHeight - labelSpacing - (midY - centerCircleRadius * 0.25 - playerRadius * 2 - labelSpacing * 3 - lineHeight * 4.5) / 2);
        gameOverLabel.setVisibility(false);
        stage.addActor(gameOverLabel);
        gameOverScoreLabel = new com.qeue.ahhh_round.components.CenteredLabel(fontFactory.get(REGULAR_FONT), Color.OFF_BLACK, height, midX, height - 3 * lineHeight - labelSpacing * 2 - (midY - centerCircleRadius * 0.25 - playerRadius * 2 - labelSpacing * 3 - lineHeight * 4.5) / 2);
        ...
        shareButton.setClickListener(new Runnable() {
            ...
            public void run() {
                if (gameState.isGameOver() && !isTransitioningToMenu && !takingScreenshot) {
                    ...
                    bus.post(new ShowShareDialogEvent(score, com.qeue.ahhh_round.utils.ScreenshotUtil.takeScreenShot()));
...
//        stage.addActor(removeAdsButton);
    ...
    private void setToSleeping() {
        ...
        if (gameState.isGameOver()) {
            ...
            for (com.qeue.ahhh_round.components.AhhhroundGameElement element : menuElements) {
                element.fadeOut(0.5);
            }
            for (com.qeue.ahhh_round.components.AhhhroundGameElement element : inGameElements) {
                element.fadeIn(0.5);
            }
            rateButton.endTextPulsate();
            skinsButton.endTextPulsate();
    ...
    private void spawnEnemy() {
        ...
        com.qeue.ahhh_round.components.Character enemy = new com.qeue.ahhh_round.components.Character(playerRadius * 2, playerRadius, selectedAngle, 0.5, assetManager.get("enemy.png", Texture.class));
    ...
    private void checkForCollisions() {
        if (!gameState.isGameOver()) {
            for (com.qeue.ahhh_round.components.Character enemy : enemies) {
    ...
    private com.qeue.ahhh_round.components.Character getFakeEnemyForScreenshot() {
        double selectedAngle = Math.PI * 0.75;
        com.qeue.ahhh_round.components.Character enemy = new com.qeue.ahhh_round.components.Character(playerRadius * 2, playerRadius, selectedAngle, 0.5f, assetManager.get("enemy.png", Texture.class));
        enemy.setPositionAroundCircle(centerCircleRadius, centerCircleCenter);
        stage.addActor(enemy);
        enemies.add(enemy);
        timeSinceLastEnemySpawn = 0;
    ...
    private void gameOver(com.qeue.ahhh_round.components.Character enemyThatKilledPlayer) {
    ...
    private void transformIntoKillerEnemy(com.qeue.ahhh_round.components.Character enemyThatKilledPlayer) {
        ...
        killer = new com.qeue.ahhh_round.components.Character(playerRadius * 2 * killerWidthToPlayerWidthRatio, playerRadius, enemyThatKilledPlayer.getCurrentAngleFromCenter(), percentageOfKillerBodyToVerticalMidpoint, assetManager.get("killerEnemy.png", Texture.class));
