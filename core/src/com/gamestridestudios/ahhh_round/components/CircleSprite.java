...
public class CircleSprite extends com.gamestridestudios.ahhh_round.components.Image {
    public CircleSprite(double radius, com.gamestridestudios.ahhh_round.components.Color color) {
        super();
