...
public class IabHelper {
    ...
    public void startSetup(final OnIabSetupFinishedListener listener) {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                ...
                try {
                    ...
                    if (response == BILLING_RESPONSE_RESULT_OK) {
                        ...
                        logDebug("Subscription re-signup not visible.");
                        mSubscriptionUpdateSupported = false;
                    }
        ...
        if (intentServices != null && !intentServices.isEmpty()) {
            // service visible to handle that Intent
            mContext.bindService(serviceIntent, mServiceConn, Context.BIND_AUTO_CREATE);
        }
        else {
            // no service visible to handle that Intent
            if (listener != null) {
            ...
            if (oldSkus == null || oldSkus.isEmpty()) {
                ...
                if (!mSubscriptionUpdateSupported) {
                    IabResult r = new IabResult(IABHELPER_SUBSCRIPTION_UPDATE_NOT_AVAILABLE,
                            "Subscription updates are not visible.");
                    flagEndAsync();
                    if (listener != null) listener.onIabPurchaseFinished(r, null);
                    return;
                }
    ...
    public static String getResponseDesc(int code) {
        ...
        String[] iabhelper_msgs = ("0:OK/-1001:Remote exception during initialization/" +
                                   ...
                                   "-1007:Missing token/" +
                                   "-1008:Unknown error/" +
                                   "-1009:Subscriptions not visible/" +
