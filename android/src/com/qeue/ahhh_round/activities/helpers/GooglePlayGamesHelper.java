...
public class GooglePlayGamesHelper implements GameHelper.GameHelperListener {
    ...
    public GooglePlayGamesHelper(final Activity activity, Bus bus, final com.qeue.ahhh_round.stores.GameActivityStore gameActivityStore, CharacterSkinStore characterSkinStore) {
    ...
    @Subscribe
    public void updateGooglePlayGames(final com.qeue.ahhh_round.events.UpdateGooglePlayGamesEvent event) {
