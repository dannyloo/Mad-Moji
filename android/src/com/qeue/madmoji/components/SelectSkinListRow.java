...
public class SelectSkinListRow extends LinearLayout {
    ...
    public void setCharacterSkinAndImage(final CharacterSkin characterSkin, Drawable skinImage, final com.qeue.madmoji.stores.CharacterSkinStore characterSkinStore) {
